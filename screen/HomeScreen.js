                    ...
                    >
                        ...
                        >
                            <AntDesign
                                ...
                                color="black"
                            />
                            <TextInput placeholder="Search ShopSphere.gh" />
                        </Pressable>
...
>
  {deals.map((item, index) => (
    <Pressable
      ...
      style={{
        marginVertical: 10,
        width: '48%', // Take up nearly half of the available width
        alignItems: "center",
      }}
    >
      <Image
...
>
  {products
    ...
    .map((item, index) => (
      <View key={index} style={{ width: '48%', marginVertical: 10 }}>
